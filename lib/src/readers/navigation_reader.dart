...
class NavigationReader {
  static Future<EpubNavigation?> readNavigation(Archive epubArchive,
    ...
    var tocManifestItem = package.Manifest!.Items.firstWhereNullable(
    ...
    var tocFileEntry = epubArchive.files.firstWhereNullable(
            (ArchiveFile file) =>
    ...
    var containerDocument = xml.XmlDocument.parse(Utf8Codec().decode(tocFileEntry.content));

    var ncxNamespace = 'http://www.daisy.org/z3986/2005/ncx/';
    var ncxNode = containerDocument
        .findAllElements('ncx', namespace: ncxNamespace).firstNullable;
    ...
    var headNode = ncxNode
        .findAllElements('head', namespace: ncxNamespace).firstNullable;
    ...
    var docTitleNode = ncxNode
        .findElements('docTitle', namespace: ncxNamespace).firstNullable;
    ...
    var navMapNode = ncxNode
        .findElements('navMap', namespace: ncxNamespace).firstNullable;
    ...
    var pageListNode = ncxNode
        .findElements('pageList', namespace: ncxNamespace).firstNullable;
  ...
  static EpubNavigationLabel readNavigationLabel(
    ...
    var navigationLabelTextNode = navigationLabelNode
        .findElements('text', namespace: navigationLabelNode.name.namespaceUri).firstNullable;
